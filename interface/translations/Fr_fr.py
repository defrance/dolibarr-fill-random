fr_FR = {
    ...
    # Boutons généraux
    "btn_defaults": "Valeurs par défaut",
    "btn_reset": "Remise à zéro",
    "btn_save": "Sauvegarder",
    "btn_connect": "Connexion",
    "btn_launch": "Lancer alimentation",
    "btn_reset_all": "Tout réinitialiser",
    "btn_field_reset": "Reset",

    # Config screen
    "config_title": "Configuration de connexion",
    "api_token": "API Token :",
    "dolibarr_version": "Version Dolibarr :",
    "base_url": "URL de base :",
    "language": "Langue :",

    # Messages de statut
    "status_saved": "Configuration sauvegardée",
    "status_reset": "Champs réinitialisés",
    "status_defaults_loaded": "Valeurs par défaut chargées",
    "status_no_defaults": "Aucun fichier de configuration par défaut trouvé",
    "status_connected": "Connexion réussie",

    # Messages d'erreur
    "error_fields_required": "Tous les champs sont obligatoires",
    "error_save": "Erreur de sauvegarde",
    "error_api": "Erreur API",
    "error_connection": "Connexion impossible",
