...
class ProjectTab(TabbedPanelItem):
    def __init__(self, yaml_manager, **kwargs):
        ...
        fields = {
            ...
            "new_max_task": "Max tâches par projet",
            "new_max_task_time": "Temps max par tâche",
            "new_max_contact": "Max contacts par projet"
        }
    ...
    def update_fields(self):
        data = self.yaml_manager.get_section("project")
