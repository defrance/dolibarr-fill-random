...
class ProductsTab(TabbedPanelItem):
    def __init__(self, yaml_manager, **kwargs):
        ...
        fields = {
            ...
            "nb_sale_price_history_max": "Nb max historique prix vente",
            "pourcentage_aug_price_max": "Pourcentage augmentation max",
            "new_stock_movement": "Mouvements de stock"
        }
    ...
    def update_fields(self):
        data = self.yaml_manager.get_section("products")
