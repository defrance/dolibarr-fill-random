...
class ContactsTab(TabbedPanelItem):
    def __init__(self, yaml_manager, **kwargs):
        ...
        fields = {
            "invoice_externe": "Facture externe",
            "invoice_interne": "Facture interne",
            "order_externe": "Commande externe",
            "order_interne": "Commande interne",
            "proposal_externe": "Proposition externe",
            "proposal_interne": "Proposition interne"
        }
    ...
    def update_fields(self):
        data = self.yaml_manager.get_section("contacts")
